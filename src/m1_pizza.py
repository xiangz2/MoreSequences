...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  1 yellow dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    draw_points_on_circle(window, circle, 1, 'yellow')
    window.close_on_mouse_click()
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(list)):
        circle1 = rg.Circle(list[k], 10)
        circle1.fill_color = color
        circle1.attach_to(window)
        list[k].attach_to(window)
        window.render()
...
def run_test_pizza():
    ...
    pizza(window, circle, 400, 'yellow', 1)
    window.close_on_mouse_click()
...
def pizza(window, circle, number_of_slices, color, thickness):
    ...
    for k in range(len(list)):
        Line = rg.Line(circle.center, list[k])
        Line.color = color
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title = '3 3 segments with thick blue lines;  6 with medium red lines.'
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(100, 100), 80)
    circle.fill_color = 'red'
    circle.outline_thickness = 3
    polygon(window, circle, 10, 'black', 5)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'FANCY POLYGON test 3:  51 lime green lines on blue circle, ' \
            'hops = 25.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'blue'
    fancy_polygon(window, circle, 51, 25, 'lime green', 5)
    window.close_on_mouse_click()
